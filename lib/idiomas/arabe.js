...
const smsLista1 = () => { return `🌟 معلومات LIGHTNINGBOT 🌟`}
...
const smsLista7 = () => { return `⚡ تثبيت LIGHTNINGBOT ⚡`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز Lightning-Bot - WhatsApp '}
...
const eLightCoins = () => { return '⚡ LightCoins' }
const eLightTickets = () => { return '🎫 Light Tickets' } 
