...
┃ ${rpgg.emoticon('money')} *LightCoins: » ${money}*
...
_2.Top LightCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}*
...
*│ ⛏️⚡ Minar LightCoins » ${new Date - user.lastcoins < 600000 ? '✘'' : '✔'}*
