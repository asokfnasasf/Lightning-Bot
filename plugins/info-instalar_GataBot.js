...
let lightning = `𝙄𝙉𝙎𝙏𝘼𝙇𝘼𝘾𝙄𝙊𝙉 𝘿𝙀 𝙇𝙄𝙂𝙃𝙏𝙉𝙄𝙉𝙂-𝘽𝙊𝙏 ⚡
...
conn.sendButton(m.chat, lightning, `Comunícate con Mí Creador si necesitas ayuda con la Instalación.\n\nContact My Creator if you need help with the Installation.\n\n${ig}\n${wm}`, picture, [
['𝘾𝙪𝙚𝙣𝙩𝙖𝙨 𝙊𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 | 𝘼𝙘𝙘𝙤𝙪𝙣𝙩𝙨 ✅', '.cuentaslb']], fkontak, m)}
